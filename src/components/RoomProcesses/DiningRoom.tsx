...
export default function DiningRoomServices() {
  ...
  return (
    <div className="body text-text lg:mb-[120px]">
      ...
      <div className="relative mb-5 md:mb-10 lg:mb-[60px] min-w-[278px] md:min-w-[712x] lg:min-w-[1076px] xl:min-w-[1516px] 4xl:min-w-[2156px] rounded-xl">
        <SynchronizedImage src="/images/processes-img/diningroom@2x.webp" roomType="diningroom" />
      </div>
