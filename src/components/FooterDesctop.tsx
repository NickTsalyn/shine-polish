...
export default function FooterDesctop() {
  return (
    <footer className="hidden lg:blok bg-transparent w-auto h-[100px] lg:flex lg:flex-col lg:justify-end  lg:ml-[200px] xl:ml-[244px] py-4 absolute inset-x-0 top-auto z-100">
