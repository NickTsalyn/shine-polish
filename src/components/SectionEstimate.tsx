    ...
    <section className=" mb-[60px] md:mb-20 lg:mb-[120px] xl:mb-40">
      <div className=" container mx-auto my-0">
        ...
        <div className="flex flex-col gap-6 justify-evenly items-center md:flex-row">
                  ...
                  <div className="flex gap-7 items-center justify-center leading-normal">
                    <button onClick={() => handleDecrement(room.id)}>
                      <Image
                        src={minus}
                        alt="minus icon"
                        className=" w-7 h-6 md:w-[42px] md:h-[42px]"
                      />
                    </button>
                    <span className=" font-medium text-base text-main md:text-4xl">
                      {roomType[room.id]}
                    </span>
          ...
          <div className="">
            <button className=" relative pl-8  md:pl-5 lg:pl-[52px] w-[333px] h-[216px] rounded-xl bg-sand/25 flex items-center md:w-[226px] md:h-[243px] lg:w-[484px] lg:h-[338px]">
