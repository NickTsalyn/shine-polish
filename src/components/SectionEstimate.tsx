	...
	return (
		<section className=" container">
			...
			<div className="flex flex-col gap-6 justify-around items-center md:flex-row">
				<div className=" flex flex-col gap-6 md:gap-10 lg:gap-12">
					<ul className="flex flex-col gap-6 md:gap-12">
						<li className="flex flex-row justify-around">
							<p className=" mr-10 font-normal text-base text-main flex justify-center items-center md:text-4xl md:leading-normal md:font-light">
								bedrooms:
							</p>
							<div className="flex gap-5 items-center justify-center leading-normal">
								<button>
					...
					<div className="flex flex-row justify-center items-center gap-2">
						<p className=" text-sand font-bold text-2xlmd:font-normal md:text-[32px] lg:font-normal lg:text-5xl">
							Previous estimate:
						</p>
				...
				<div className=" w-[280px] h-[216px] rounded-xl bg-sand/25 flex justify-center items-center relative md:w-[226px] md:h-[243px] lg:w-[484px] lg:h-[338px]">
					<span className="font-bold text-[44px] pr-20 pl-5 text-center text-accent md:text-[32px]">Full estimate</span>
					<Image
						src={img}
						alt="Estimate"
