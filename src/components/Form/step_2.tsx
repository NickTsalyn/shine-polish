      ...
      <div className="container">
        <div className="max-w-[278px] md:max-w-[682px] lg:max-w-[1160px] xl:max-w-[1572px] m-auto mb-5 xl:mb-[35px]">
          ...
          <p className="text-bookingSubText font-normal mb-5 leading-[14.4px] text-[12px] md:text-[24px] md:leading-[32px] lg:leading-[28.8px] xl:hidden">
            Add extras to customize your cleaning service.<br className="hidden md:block lg:hidden"/> Remember <span className=" font-bold">deep cleaning </span>
          ...
          <p className="hidden xl:block text-bookingSubText font-normal lg:leading-[28.8px] md:text-[24px] ">Add extras to customize your cleaning service. Remember  deep cleaning is recommended for all first time cleans to prepare your home for routine services. Move In/Move Out requires a vacant home with water and electricity for a proper cleaning</p>
        </div>
            ...
            {ServicesOptions.map(({ value, label }) => {
              return (
                ...
                >
                  <RadioButton
                    value={value}
                    style=" py-[10px] px-[20px] md:py-[22px] md:px-[10px] lg:py-[20px] h-full w-full md:text-[24px] md:text-accent md:leading-[28.8px]"
