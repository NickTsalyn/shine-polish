...
const Step7 = () => {
  ...
  return (
    <div className="p-4 md:p-6 lg:p-9 flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2 md:flex-row md:gap-[100px]">
        <div>
          <ul className="list-disc ml-6 flex flex-col gap-0.5  text-main">
        ...
        <div className="md:columns-2 gap-[40px]">
