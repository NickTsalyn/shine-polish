    ...
    <div className="py-4 md:py-6 lg:py-9 lg:min-h-[600px] xl:h-[1000px] lg:justify-between">
      <div className="mb-10 xl:mb-20">
        ...
        <div className="flex flex-col md:flex-row md:flex-wrap lg:flex-nowrap gap-4 lg:gap-6 mb-5 md:mb-6 ">
          {/* Name */}
          <div className="w-full md:w-[calc(50%-12px)] lg:w-2/4 relative mb-[10px]">
            <Controller
              name="name"
              control={control}
          ...
          {/* Surname */}
          <div className="w-full md:w-[calc(50%-12px)] lg:w-2/4 md:h-[48px] relative mb-[10px]">
            <Controller
              name="surname"
              control={control}
              rules={{ required: "This field is required" }}
          ...
          {/* Email */}
          <div className="w-full md:w-[calc(50%-12px)] lg:w-2/5 md:h-[48px] mb-[10px] relative">
            <Controller
              name="email"
              control={control}
              rules={{ required: "This field is required" }}
        ...
        <div className="flex flex-col  lg:w-full  mb-10 lg:mb-[60px] ">
          <h2 className="mb-6 md:mb-7 lg:mb-5 text-2xl md:text-4xl font-medium md:font-normal">
            Additional information
          </h2>
          <div className=" flex flex-col lg:flex-row lg:flex-nowrap gap-4  md:gap-6  mb-2">
            <div className="w-full lg:w-4/12 mb-[10px] relative">
              <Controller
                name="homeAccess"
                control={control}
            ...
            <div className="w-full lg:w-4/12 relative mb-[20px]">
              <Controller
                name="aboutUs"
                control={control}
                rules={{ required: "Please select an option" }}
