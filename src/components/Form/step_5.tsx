    ...
    <div className=" py-8 flex flex-col gap-6 lg:flex-row lg:flex-wrap justify-between">
      <div className=" flex flex-col gap-6 lg:min-w-[500px] lg:max-w-[600px] w-full mb-[40px] lg:mb-0 xl:w-[900px]">
        ...
        <p className=" body text-subtext ">
          If you have a question about our company, ask it in the next field.
          We’ll answer to you on email{" "}
        </p>
        <div className="h-48">
          <Textarea
            name="question"
      ...
      <form className=" flex flex-col justify-center lg:justify-start gap-4 mb-[40px]">
        <h2 className="text-2xl md:text-4xl font-medium lg:mb-5">
          Discount code
        </h2>
      ...
      <div className=" lg:flex md:flex-col lg:w-[500px]">
        <h2 className="text-center text-rose-900 text-4xl mb-5">
