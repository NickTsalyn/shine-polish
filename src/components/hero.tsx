...
export default function Hero() {
  ...
  return (
    <>
      <section
        className="p-5 lg:p-10 relative bg-cover bg-center bg-no-repeat mb-[60px] "
        style={{
          backgroundImage: `linear-gradient(185deg, rgba(10, 10, 10, 0.39) 2.66%, rgba(120, 120, 120, 0.00) 81.3%), url(${mobileImage.src})`,
        }}
      >
        <div>
          <h1 className=" h1 text-white text-shadow max-w-[282px] md:max-w-[730px] lg:max-w-[1124px] text-xl md:text-[52px] lg:text-[80px] md:leading-normal text-center font-medium mb-[138px] md:mb-[248px] lg:mb-[390px] mr-auto ml-auto">
