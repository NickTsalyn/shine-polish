 ...
 return (
  <section className="relative">
   <div className="mx-0 my-auto">
    ...
    <div
     data-aos="fade-right"
     className=" container pb-5 px-5 pt-5 lg:pr-[40px] xl:pr-[80px] md:pt-8 lg:pt-16 xl:pt-18 md:py-10 lg:pl-[40px] xl:pl-[80px] absolute top-1 inset-0 flex flex-col justify-between z-10 lg:h-[90vh] xl:h-[90vh]"
    >
