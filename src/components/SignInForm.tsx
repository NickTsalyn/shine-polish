...
export default function SignInForm() {
 ...
 return (
  <div className="flex flex-col mb-[40px] lg:h-screen">
   <div className="m-auto relative w-[260px] md:w-[712px] lg:w-[960px] h-auto md:h-[500px] lg:h-[575px] rounded-xl md:rounded-[50px] md:flex shadow-main-shadow">
    <div className="absolute top-2 right-4 z-10 md:top-[28px] md:right-[32px]">
     <Button
      style="close-button"
      type="button"
      // onClick={() => router.push("/")}
     ...
     <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex flex-col justify-center items-center">
       <label className="mb-[10px]">
        <span className="text-text text-[14px] lg:text-[20px]  lg:font-thin">Or sign using E-Mail address</span>
       </label>
       <label
        htmlFor="email"
        className="relative"
       >
        ...
        {errors.email && (
         <p
          role="alert"
          className="text-accent-light text-[12px] absolute bottom-[0] left-2 "
         >
       ...
       <p className="text-accent text-[12px] lg:text-[16px] mb-[18px] md:mb-[30px] lg:font-light hover:underline transition duration-300">
       ...
       <Button
        ...
        type="submit"
       >
        <span className="text-white text-[20px] uppercase">Sign In</span>
       </Button>
      </div>
     </form>
    </div>
    ...
    <div className="md:bg-main md:w-[356px] lg:w-[480px] md:h-[500px] lg:h-[576px] relative  bottom-0 left-0  md:rounded-br-[50px] md:rounded-tr-[50px]">
     ...
     <div className="absolute z-30 bottom-[32px] md:bottom-[183px] left-[12px] md:left-0 flex flex-col px-[12px] md:px-0 md:w-[356px] md:justify-center md:items-center lg:w-[480px]">
      <h3 className="text-white text-[24px] font-bold mb-2 lg:mb-[42px] lg:font-light lg:text-[48px]">
       Create Account!
      </h3>
