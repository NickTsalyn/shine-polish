...
<div className=' absolute w-[133.3px] h-[150.73px] md:w-[311px] md:h-[390px] lg:w-[500.92px] lg:h-[541.29px] xl:w-[521.07px] xl:h-[531.43px] right-[-40px] md:right-[-60px] lg:right-[80px] xl:right-[230px] bottom-[-40px] md:bottom-[-60px] lg:bottom-[-90px] rotate-6 md:rotate-[-11deg] xl:rotate-[4deg]'><ChecklistImg/></div>
</div>
