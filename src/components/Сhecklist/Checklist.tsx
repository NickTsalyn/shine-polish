  ...
  return (
    <section>
      <div className="container">
        ...
        <div className="grid grid-cols-2 auto-rows-auto gap-[60px]">
        <ul className="grid grid-cols-1 auto-rows-auto gap-[60px]" > {cards.map((card, index) =>{ if (index <=5) { 
            return(
        ...
        <ul className="grid grid-cols-1  gap-[60px]">
          {cards.map((card, index) =>{ if (index > 5) { 
            return(
          ...
          <li className="row-span-2  min-h-[627px]" >
            <AboutUs />
          </li>
        </ul>
        </div>
