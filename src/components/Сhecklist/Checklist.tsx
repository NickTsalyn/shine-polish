        ...
        return (
         ...
         >
          <div>
           ...
           {card.p && <p className="text-[16px] md:text-[20px] leading-[20px] md:leading-[24px] text-text">{card.p}</p>}
           {card.li && (
            <ul className="pl-5">
              ...
              if (typeof list === "string") {
               return (
                <li
                 ...
                 className="list-disc "
                >
                 <p className="text-text text-[16px] md:text-[20px] leading-[20px] md:leading-[24px]">{list}</p>
                </li>
               );
              }
