  ...
  <div className="w-[320px] md:w-[712px] lg:w-[960px] m-auto lg:h-screen">
   <div className="flex flex-col items-center py-10 px-8 md:py-[60px] lg:p-16 mb-10 relative">
    ...
    <h4 className="text-base/[22px] md:text-[18px] text-text text-center block mb-8 md:mb-4">
     Let’s set up your account. <br className="md:hidden" /> Already have one?{" "}
     <a
      href="/sign-in-form"
      className="text-tertial"
     >
      Sign In here
     </a>
    </h4>
    ...
    >
     <div className="flex flex-col gap-4 md:w-[300px] lg:w-[348px]">
      <label
       ...
       className="relative"
      >
       <span className="text-main text-[14px] md:text-[16px] ml-3">Name:</span>
       <Input
        type="text"
        style="sign-up-input"
        width="lg:w-[348px]"
      ...
      <label
       ...
       className="relative"
      >
       <span className="text-main text-[14px] md:text-[16px] ml-3">Email:</span>
       <Input
        type="email"
        style="sign-up-input"
        width="lg:w-[348px]"
        ...
        aria-required={errors.email || (mutation.isError && mutation.error.response.status === 409) ? "true" : "false"}
       />
       {errors.email && (
        <p
         role="alert"
      ...
      <label
       ...
       className="relative"
      >
       <span className="text-main text-[14px] md:text-[16px] ml-3">Password:</span>
       <Input
        type="password"
        style="sign-up-input"
        width="lg:w-[348px]"
     ...
     <div className="flex gap-x-8 md:gap-x-5 items-center justify-center">
      <p className="block text-text text-[10px]/3 w-[120px] md:w-[154px] lg:w-[180px]">
       By submitting the form you are agree to our <span className="text-tertial">Terms of Service</span>
      </p>
      <Button
       type="submit"
       style="auth-sign"
