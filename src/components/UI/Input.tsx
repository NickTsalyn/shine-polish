...
export default function Input({
  ...
  switch (style) {
    ...
    case "form-input":
      styles =
        "block mx-auto mb-[10px] w-full md:w-[600px] lg:w-[800px] py-[8px] lg:py-[12px] px-[9px] lg:px-[16px] bg-transparent text-secondary border-solid border-2 focus:border-[3px] border-secondary rounded-[12px] focus:shadow-input-shadow outline-none placeholder:text-secondary-placeholder placeholder:opacity-50";
      break;
    case "modal-input":
      styles =
