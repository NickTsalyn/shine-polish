...
export default function Button(props: PropsButtton) {
  ...
  switch (props.style) {
    ...
    case "apply-btn-light":
      styles =
        " rounded-xl border-2 border-secondary   bg-secondary  py-1 px-[54px] hover:shadow-apply-send-button-shadow  focus:shadow-apply-send-button-shadow  ";
      break;
    ...
    case "complete-booking":
      styles =
        "w-[90%] py-1.5 md:py-3 lg:py-[20px] px-10 bg-transparent border-2 border-solid border-white rounded-xl ";
      break;
    case "repeat-last-booking":
      styles =
        "w-full md:w-[360px] bg-repeat-last-booking-bgn rounded-lg flex justify-center items-center px-4 py-3";
      break;
    case "create-new-booking":
      styles =
        "w-full md:w-[360px] bg-create-new-booking-bgn rounded-lg flex justify-center items-center px-4 py-3";
      break;
    default:
  }
  return (
