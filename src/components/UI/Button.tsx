...
export default function Button(props: PropsButtton) {
  ...
  switch (props.style) {
    ...
    case "home-book-now":
      styles =
        "py-1 md:py-2 lg:py-2 xl:py-3  px-4 md:px-[54px] lg:px-12 xl:px-17  border border-solid border-secondary rounded-[10px] backdrop-blur-[10px]   ";
      break;
    case "home-contact-us":
      styles =
        "py-1 md:py-2 lg:py-2 xl:py-3  px-3 md:px-12 lg:px-10 xl:px-17  border border-solid border-secondary rounded-[10px] backdrop-blur-[10px]   ";
      break;
