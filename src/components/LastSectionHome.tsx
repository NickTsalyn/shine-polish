...
import bgPhoto from "../../public/images/lastSectionPhoto@2x.jpg";
  ...
  return (
    <section>
      <div className="mx-0 my-auto relative ">
        ...
        <div className="pb-5 px-5 pt-5 lg:pr-[40px] xl:pr-[80px] md:pt-8 lg:pt-16 xl:pt-18 md:py-10 lg:pl-[240px] xl:pl-[282px] absolute inset-0 flex flex-col z-10 top-1 ">
          <h2 className="text-white h2 text-center drop-shadow-md top-0">
            Enjoy the time spent with your <br />
            loved ones...
          </h2>

          <div className="flex  absolute inset-x-0 bottom-10 items-center z-10 justify-between px-5 md:px-7 lg:pl-[240px]	xl:pl-[280px]">
