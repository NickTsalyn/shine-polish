...
export const Reviews: React.FC = () => {
  return (
    <section id="reviews" className=" mx-auto sm:mb-[60px] md:mb-[80px] lg:mb-[120px] xl:mb-[160px]">
          ...
          {reviews.map((review, index) => (
            ...
            >
              <div>
                ...
                >
                  <span className="text-2xl"> {"❝"}</span> {review.review}
                  {"❞"}
                </p>
                <p
                  className={`  sm:text-[16px] md:text-[16px] lg:text-[24px] xl:text-[24px] sm:leading-[19px] md:leading-[19px] lg:leading-[28px] xl:leading-[28px]  text-right max-h-[29px] absolute sm:bottom-[10px] md:bottom-[28px] lg:bottom-10 xl:bottom-10 sm:right-[12px] md:right-[28px] lg:right-5 xl:right-5`}
                >
                  {review.author}
                </p>
              </div>
