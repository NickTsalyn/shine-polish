import { MOVE_INOUT_SERVICES } from "@/content/cleaning-service/move-cleaning";
  ...
  return (
    <div className=" body text-text  flex flex-col justify-start items-start lg:mb-[120px]">
      ...
      <div className=" mb-2 md:mb-5 lg:mb-0">
        <BasicBreadcrumbs pageHref="move-in-out-services" roomName="Move-In and Move-Out Cleaning" />
      </div>
      <div>
        ...
        <h2 className=" text-xl md:text-3xl text-main mb-5 md:mb-0  ">{outServices.title}</h2>
        <ul className="flex flex-col gap-5 lg:gap-8 mb-5 lg:mb-8">
        ...
        <h2 className=" text-xl md:text-3xl text-main mb-5 md:mb-0  ">{inServices.title}</h2>
        ...
        <p className=" mb-5 lg:mb-8">
          ...
          <span className=" font-bold">{involves.generalDustingParagraphThird}</span>
        </p>
