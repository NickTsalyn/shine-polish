import { DEEP_CLEANING } from "@/content/cleaning-service/deep-cleaning";
    ...
    <div className=" body text-text  flex flex-col justify-start items-start lg:mb-[120px]">
      ...
      <div>
        ...
        <p className=" mb-5 md:mb-8">
          {services.paragraphFirst} <span className=" font-bold">{services.paragraphAccent}</span>{" "}
          {services.paragraphSecond}
        </p>
        <h3 className="text-main lg:text-text lg:font-bold">{services.subtitleFirst}</h3>
        ...
        <h3 className="text-main  lg:text-text lg:font-bold">{services.subtitleSecond}</h3>
        <ul className=" list-disc pl-5 mb-5 md:mb-8">
          {services.listSecont.map((p, index) => (
            <li key={index}>{p}</li>
          ))}
        </ul>
        <h3 className="text-main  lg:text-text lg:font-bold">{services.subtitleThird}</h3>
        <p className=" mb-5 md:mb-8">{services.thirdParagraph}</p>
        <h3 className="text-main  lg:text-text lg:font-bold">{services.subtitleFourth}</h3>
        <ul className=" list-disc pl-5">
        ...
        <h3 className="text-main  lg:text-text lg:font-bold">{services.subtitleFifth}</h3>
        ...
        <h3 className="text-main  lg:text-text lg:font-bold">{homeNeeds.subtitle}</h3>
        <ul className="flex flex-col gap-5 lg:gap-8 mb-5 lg:mb-8">
          {homeNeeds.paragraphs.map((p, index) => (
            <li key={index}>{p}</li>
          ))}
        </ul>
        <h3 className="text-main  lg:text-text lg:font-bold">{homeNeeds.subtitleFirst}</h3>
        <p className=" mb-5 md:mb-8">{homeNeeds.firstParagraph}</p>
        <h3 className="text-main  lg:text-text lg:font-bold">{homeNeeds.subtitleSecond}</h3>
        <ul className="flex flex-col gap-5 lg:gap-8 mb-5 lg:mb-8">
          {homeNeeds.secondParagraphs.map((p, index) => (
            <li key={index}>{p}</li>
          ))}
        </ul>
        <h3 className="text-main  lg:text-text lg:font-bold">{homeNeeds.subtitleThird}</h3>
        <p className=" mb-5 md:mb-8">{homeNeeds.thirdParagraph}</p>
        <h3 className="text-main  lg:text-text lg:font-bold">{homeNeeds.subtitleFourth}</h3>
        <p className=" mb-5 md:mb-8">{homeNeeds.fourthParagraph}</p>
        <h3 className="text-main  lg:text-text lg:font-bold">{homeNeeds.subtitleFifth}</h3>
