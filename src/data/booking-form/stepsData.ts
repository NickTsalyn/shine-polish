...
export const  ExtrasOptions  = [
	{ value: "Organizing", label: "Organizing", path:'/icons/step_2_form_icons/organizing_c.svg', style:'hidden md:block md:w-full md:h-full ' },
    ...
    { value: "Inside Windows", label: "Inside Windows", path:'/icons/step_2_form_icons/window_c.svg', style:'hidden md:block md:w-full md:h-full' },
