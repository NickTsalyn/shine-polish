export const DINING_ROOM_PROCESS = {
  ...
  processes: {
    title: "Dining Room Cleaning Process",
    ...
    summary:
      "By following this comprehensive dining room cleaning process, you can ensure that your dining space remains inviting and ready for meals and gatherings. Adjust the frequency of tasks based on your lifestyle and preferences.",
  },
  frequencies: {
    title: "How Often Should You Clean Your Dining Room?",
    text: "The frequency of dining room cleaning can vary based on factors such as the level of use, the presence of spills or stains, and personal preferences. Here's a general guide for how often you should perform various cleaning tasks in your dining room:",
    items: [
      {
        title: "Daily:",
      ...
      },
      {
        title: "Weekly:",
        description: [
          "Dust furniture, including the dining table, chairs, and other surfaces, on a weekly basis to prevent the buildup of dust.",
          "Vacuum or sweep the dining room floor weekly to remove dirt and debris. Mop if the floor surface allows.",
          "Dust and clean light fixtures, including chandeliers or pendant lights, weekly to maintain a well-lit and clean environment.",
        ],
      },
      {
        title: "Bi-Weekly/Monthly:",
        description: [
          "Perform a deeper cleaning of furniture surfaces, including wiping down and polishing wooden furniture, on a bi-weekly or monthly basis.",
          "Clean windows and window treatments every two weeks to a month, depending on the accumulation of dust.",
        ],
      },
      {
        title: "Quarterly/Seasonal:",
        description: [
          "If your dining chairs have upholstered seats, consider a deeper cleaning on a quarterly or seasonal basis.",
          "Check and clean air vents or grilles quarterly to ensure proper air circulation.",
        ],
      },
      {
        title: "As Needed:",
        description: [
          "Address stains or spills on the dining table, chairs, or upholstery as soon as they occur.",
          "Check tablecloths or runners for stains or spills and launder or replace them as needed.",
          "Clean and dust decorative elements in the dining room as needed.",
        ],
      },
    ],
    summary:
      "Remember, these are general guidelines, and you may need to adjust the frequency based on your lifestyle, the size of your dining room, and personal preferences. Regular maintenance helps prevent the buildup of dirt and ensures a consistently clean and inviting dining space.",
  },
  needs: {
    title: "Why You Need Dining Room Cleaning?",
    ...
    summary:
      "In summary, dining room cleaning is not merely a matter of appearance; it plays a crucial role in promoting hygiene, comfort, and a positive atmosphere during meals. Regular maintenance of the dining room ensures a clean and inviting space for dining and socializing.",
  },
};
