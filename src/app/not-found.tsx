  ...
  return (
    <div className="relative h-[calc(100vh-84px)] md:h-[calc(100vh-96px)] lg:h-screen w-full ">
      ...
      <div className="container flex flex-col justify-around items-center  py-9 md:py-11 lg:py-12 h-full">
        ...
        <div className="text-white text-xl md:text-2xl lg:text-4xl items-end">
          <Link className="pr-2" href={"/"}>to Home</Link>
          <LogoutIcon className="size-5 md:size-7 lg:size-9 xl:size-11"/>
        </div>
      </div>
    </div>
  );
